...
import styles from './CardLike.module.css';
...
export const CardLike = ({
  ...
  return (
    ...
    >
      ...
      <span className={styles.cardLike_title}>Like</span>
    </div>
  );
};
